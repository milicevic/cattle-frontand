...
export function InseminationWidget() {
  ...
  const handleRecordInsemination = async () => {
    ...
    try {
      const response = await api.post(`/api/animals/${selectedCow.animal_id}/insemination`, {
                    ...
                    <TableRow key={cow.cow_id}>
                      ...
                      <TableCell>
                        <span className={getStatusColor(cow.status, cow.is_overdue)}>
                          {cow.days_since_calving} days
                        </span>
                      </TableCell>
                      <TableCell>
                        <span className={getStatusColor(cow.status, cow.is_overdue)}>
                          {cow.is_overdue ? 'Overdue' : `${cow.days_until_ideal} days`}
                        </span>
                      </TableCell>
                      <TableCell>
